...
urlpatterns = [
    ...
    path("course/lesson/text/<int:ID>", views.text_lesson_view, name = "text_lesson_view"),
    path("course/lesson/video/<int:ID>", views.video_lesson_view, name = "video_lesson_view")
]